...
describe("DeepSeek V4 output windows", () => {
  test("allows the 384K output maximum for Pro-0813 hosted aliases", () => {
    expect(getModelMaxOutputTokens("deepseek-v4-pro")).toEqual({
      default: 64_000,
      upperLimit: 384_000,
    });
    expect(getModelMaxOutputTokens("deepseek-v4-pro-0813")).toEqual({
      default: 64_000,
      upperLimit: 384_000,
    });
  });
