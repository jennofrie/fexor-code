...
# fexor-code installer
# Usage: curl -fsSL https://raw.githubusercontent.com/jennofrie/fexor-code/main/install.sh | bash
...
REPO="https://github.com/jennofrie/fexor-code.git"
INSTALL_DIR="$HOME/fexor-code"
...
build_binary() {
  info "Building fexor-code (all experimental features enabled)..."
  cd "$INSTALL_DIR"
...
link_binary() {
  ...
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/fexor-code"
  ok "Symlinked: $link_dir/fexor-code"
...
printf "    ${CYAN}fexor-code${RESET}                          # interactive REPL\n"
printf "    ${CYAN}fexor-code -p \"your prompt\"${RESET}          # one-shot mode\n"
echo ""
printf "  ${BOLD}Set your API key:${RESET}\n"
printf "    ${CYAN}export ANTHROPIC_API_KEY=\"sk-ant-...\"${RESET}\n"
echo ""
printf "  ${BOLD}Or log in with Claude.ai:${RESET}\n"
printf "    ${CYAN}fexor-code /login${RESET}\n"
echo ""
printf "  ${DIM}Source: $INSTALL_DIR${RESET}\n"
printf "  ${DIM}Binary: $INSTALL_DIR/cli-dev${RESET}\n"
printf "  ${DIM}Link:   ~/.local/bin/fexor-code${RESET}\n"
echo ""
